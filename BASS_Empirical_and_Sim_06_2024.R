...
input_file =paste0(basepath, '/FredResults/' , cursimPath, '/1-main.csv') #qualitative_sim_v3
aSIMb <-   read.csv(input_file)
aSIMb <- aSIMb[aSIMb$rt <5,]

input_file =paste0(basepath, '/FredResults/' , cursimPath, '/1-flatprior.csv') #qualitative_sim_v3
aSIMbfp <-   read.csv(input_file)
aSIMbfp <- aSIMbfp[aSIMbfp$rt <5,]

input_file =paste0(basepath, '/FredResults/' , cursimPath, '/1-zeroprior.csv') #qualitative_sim_v3
aSIMbzp <-   read.csv(input_file)
aSIMbzp <- aSIMbzp[aSIMbzp$rt <5,]

# Study 2
input_file =paste0(basepath, '/FredResults/' , cursimPath, '/2-main.csv') #qualitative_sim_v3
aSIMc <-   read.csv(input_file)
aSIMc <- aSIMc[aSIMc$rt <5,]

input_file =paste0(basepath, '/FredResults/' , cursimPath, '/2-nometa.csv') #qualitative_sim_v3
aSIMcac <-   read.csv(input_file)
aSIMcac <- aSIMcac[aSIMcac$rt <5,]


input_file =paste0(basepath, '/FredResults/' , cursimPath, '/2-overconf.csv') #qualitative_sim_v3
